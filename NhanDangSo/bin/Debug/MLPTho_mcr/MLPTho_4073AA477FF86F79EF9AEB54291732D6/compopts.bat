...
rem
rem    $Revision: 1.1.8.5 $  $Date: 2006/12/20 04:57:50 $
rem
rem ********************************************************************
...
set CPPCOMPFLAGS=-c -Zp8 -GR  -W3 -EHsc- -Zc:wchar_t- -nologo -Zm500 -MD -I"%MATLAB%\extern\include\cpp" -DMSVC -DIBMPC -DMSWIND /D_SECURE_SCL=0 %VER_SPECIFIC_OPTS%
set DLLCOMPFLAGS=-c -Zp8 -GR -EHsc- -Zc:wchar_t- -W3 -nologo -I"%MATLAB%\extern\include\win32" -DMSVC -DIBMPC -DMSWIND %VER_SPECIFIC_OPTS%
